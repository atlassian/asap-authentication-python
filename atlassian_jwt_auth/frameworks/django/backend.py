...
class DjangoBackend(Backend):
    ...
    def get_401_response(self,data:Optional[Any]=None, headers: Optional[Any]=None, request: Optional[HttpRequest]=None) -> HttpResponse:
        if headers is None:
            headers = {}
    ...
    def get_403_response(self, data:Optional[Any]=None, headers: Optional[Any]=None, request: Optional[HttpRequest]=None) -> HttpResponse:
        if headers is None:
            headers = {}
